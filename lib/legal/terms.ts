...
- You can delete your account at any time (Settings → Danger zone). A 30-day grace window applies, after which personal data is purged.
...
- Use the Service to send mass unsolicited messages.
...
- Use bots, automation, or sock-puppet accounts to inflate viewer counts, tips, fantasy scores, or prediction outcomes.
...
- Your channel may be monitored by EVO TV moderators. We may force-end streams, hide VODs, or suspend channels that violate the Standards.
- Stream keys are confidential. If leaked, rotate immediately via the partner dashboard.
- Payouts are processed weekly via Paystack Transfers. EVO TV takes a platform fee before disbursement.

EVO TV may terminate a partner relationship for cause.
...
EVO TV may suspend, ban, or terminate your account (or a partner channel) without prior notice if you violate these Terms, violate the Community Standards, create legal risk, or request termination via account deletion.
...
- We don't guarantee uninterrupted streams.
...
We may update these Terms. Material changes will be announced in-app and via email. Continued use after a revision is acceptance.
